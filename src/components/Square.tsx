// biome-ignore lint/style/useFilenamingConvention: React/hook naming convention
import { MouseButton, type SquarePosition } from "~/core/types";
import type { useLongPress } from "~/hooks";
...
export function Square({
  ...
  const pressButtons = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (e.button === MouseButton.middle) {
      ...
      if (surroundings) {
        revealSurroundings(surroundings);
      }
    }
  };
